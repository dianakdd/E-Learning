    ...
    <header class="desktop-header-1 light d-flex align-items-start flex-column">
        ...
        <nav>
            <ul class="vertical-menu scrollspy">
                ...
                <li><a href="jadwal1.php"><i class="icon-grid"></i>&ensp;Jadwal Kuliah</a></li>
                <li><a style=" color: #FF4C60; text-shadow: 3px 3px 6px #b8b9be, -3px -3px 6px #fff;" href="upload1.php"><i class="icon-layers"></i>&ensp;Tugas Online</a></li>
    ...
    <main class="content">
        ...
        <section>
            ...
            <div class="container">
                ...
                <!-- section title -->
                <h2 class="section-title wow fadeInUp">TUGAS ONLINE</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="contact-info">
                            <p class="wow fadeInUp">Jangan Lupa submit tugas!</p>
                        </div>
                    </div>

                    <div class="col-md-8">
                        <!-- Contact Form -->
                        <form id="contact-form" class="contact-form mt-6" method="post" action="proses_upload.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="column col-md-12">
                                    <!-- Email input -->
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="InputSubject" name="inputnama" placeholder="Nama: ">
